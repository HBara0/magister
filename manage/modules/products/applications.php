...
if(!$core->input['action']) {
    ...
    $publishonwebcheckbox = '<input type="checkbox" value="1" name="segmentapplications[publishWebsite]">';
    ...
    elseif($core->input['action'] == 'get_editbox') {
        ...
        if($application->publishWebsite == 1) {
            $checked = 'checked="checked"';
        }
        $segments = ProductsSegments::get_segments();
        $segments_list = parse_selectlist('segmentapplications[psid]', 2, $segments, $application->psid);
        $publishonwebcheckbox = '<input type="checkbox" value="1" name="segmentapplications[publishWebsite]" '.$checked.'>';
