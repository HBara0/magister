<tr class="{$altrow}"  style="border:1px gainsboro solid;width:100%" id="{$segment[psid]}_{$sprowid}">
    <td colspan="2">
        ...
        <div style="display:inline-block;width:65%;"><a {$display[product]} onclick="$('#prof_mkd_chemsubfield_{$segment[psid]}{$srowid}{$sprowid}').toggle();">or use chemical substance instead.</a></div>
    </div>
