    ...
    <form name='perform_profiles/representativeslist_Form' id="perform_profiles/representativeslist_Form" method="post">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <table>
                        <tbody id="entity_{$repid}_tbody"  class="{$altrow_class}">
                            {$companieslist}
                        </tbody>
                        <tfoot>
                            <tr><td valign="top">
                                    <img src="{$core->settings['rootdir']}/images/add.gif" style="cursor: pointer" id="ajaxaddmore_profiles/representativeslist_entity_{$repid}" alt="Add">Add more fields
                                    <input id="numrows_entity_{$repid}" name="numrows_entity_{$repid}" type="hidden" value="{$rownum}">
                                </td></tr>
                        </tfoot>
                    </table>
                </td>
