...
<div style="display:block;" >
    ...
    <div id="savingsection_{$sequence}_section2" {$hideforfirstime}>
...
<div id="savingsection_{$sequence}_section3" {$hideforfirstime}>
...
<div id="savingsection_{$sequence}_section4" {$hideforfirstime}>
...
<div id="savingsection_{$sequence}_section5" {$hideforfirstime}>
