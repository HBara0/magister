...
<div>
    ...
    <table>
        ...
        <tfoot>
            ...
            <tr><td colspan="2">{$lang->estimatedduedate}</td>
                <td><input type="hidden" name ="cpurchasetype" id="cpurchasetype"/><input type="text"   name="avgeliduedate" id="avgeliduedate" value="{$avgeliduedate}" class="automaticallyfilled-noneditable"/></td>
            </tr>
        </tfoot>
    </table>
</p>
