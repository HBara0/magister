<div style="display:block;width:100%; margin-top:15px;margin-bottom :15px; padding:5px; border:1px solid #FCEFA1;">
    ...
    <div style="display:block; ">
        ...
        <div style="display:inline-block;padding:5px;width:15%;"> <input tabindex="3" size="10" id="numnight_segacc_0_{$sequence}" accept="numeric" name="segment[{$sequence}][tmhid][{$otherhotel_checksum}][numNights]" type="text" value="" max="{$leavedays}"> </div>
