<meta http-equiv="Content-Type" content="text/html; charset={$lang->settings[charset]}" />
<meta http-equiv="Content-Script-Type" content="text/javascript" />
<link rel="shortcut icon" href="{$core->settings[rootdir]}/images/favicon.ico" />
<script src="{$core->settings[rootdir]}/js/jquery-1.7.min.js" type="text/javascript"></script>
