<div class="ui-state-highlight ui-corner-all" style="padding-left: 5px; margin-bottom:10px;">
    ...
    <div style="padding:5px;">
        {$leave->get_displayname()} - <span style="font-weight: bold;{$hideleavedtls_link}"><a target="_blank" href="{$core->settings['rootdir']}/index.php?module=attendance/viewleave&id={$leave->lid}">{$lang->viewleave}</a></span>
