<tr id="{$rownums}">
    ...
    <td style="vertical-align:top; padding:2px; border-bottom: dashed 1px #CCCCCC;" align="center" class="border_right"><input id="october_{$rowid}" type="hidden" name="budgetline[{$rowid}][october]" value="{$budgetline[october]}"><input name="budgetline[{$rowid}][octoberqty]" data-perc="october_{$rowid}" data-quantity="{$rowid}" type="number" step="any" id="octoberqty_{$rowid}" size="10"  required="required" value="{$budgetline[octoberqty]}" autocomplete='off'/><span style="color:red" id="alertpercentage_{$rowid}"></span></td>
    <td style="vertical-align:top; padding:2px; border-bottom: dashed 1px #CCCCCC;" align="center" class="border_right"><input id="november_{$rowid}" type="hidden" name="budgetline[{$rowid}][november]" value="{$budgetline[november]}"><input name="budgetline[{$rowid}][novemberqty]" data-perc="november_{$rowid}" data-quantity="{$rowid}"  type="number" step="any" id="novemberqty_{$rowid}" size="10"  required="required" value="{$budgetline[novemberqty]}" autocomplete='off'/></td>
    <td style="vertical-align:top; padding:2px; border-bottom: dashed 1px #CCCCCC;" align="center" class="border_right"><input id="december_{$rowid}" type="hidden" name="budgetline[{$rowid}][december]" value="{$budgetline[december]}"><input name="budgetline[{$rowid}][decemberqty]" data-perc="december_{$rowid}" data-quantity="{$rowid}"  type="number" step="any" id="decemberqty_{$rowid}" size="10"  required="required" value="{$budgetline[decemberqty]}" autocomplete='off'/></td>
    <td style="vertical-align:top; padding:2px; border-bottom: dashed 1px #CCCCCC;" align="center" class="border_right">
        <input name="budgetline[{$rowid}][quantity]" type="number" step="any" id="Qty_{$rowid}" size="10"  data-rowid="{$rowid}" data-totalquantity="{$rowid}" data-name="{$lang->quantity}" data-max="{$maxbudgetline[quantity]}" value="{$budgetline[quantity]}"{$required} readonly="readonly">
        {$previous_yearsqty}
    </td>
    ...
    <td style="vertical-align:top; padding:2px; border-bottom: dashed 1px #CCCCCC;" align="center" class="border_left"><input name="budgetline[{$rowid}][unitPrice]" type="number" step="any" id="unitprice_{$rowid}" size="10"  {$required} value="{$budgetline[unitPrice]}" data-rowid="{$rowid}"  data-max="{$maxbudgetline[unitPrice]}" data-name="{$lang->unitprice}" autocomplete='off' />{$prevyear_unitprice}</td>
    ...
    <td style="vertical-align:top; padding:2px; border-bottom: dashed 1px #CCCCCC;" align="center" class="border_left"><input name="budgetline[{$rowid}][amount]" type="number" step="any" id="amount_{$rowid}" size="10"  {$required} value="{$budgetline[amount]}" data-rowid="{$rowid}" data-name="{$lang->amount}" data-max="{$maxbudgetline[amount]}" autocomplete='off' />{$previous_yearsamount}</td>
    <td style="vertical-align:top; padding:2px; border-bottom: dashed 1px #CCCCCC;" align="center" class="border_left"><input name="budgetline[{$rowid}][incomePerc]"  type="number" step="any" id="amountper_{$rowid}" size="10"  {$required} value="{$budgetline[incomePerc]}"  autocomplete='off' />{$prevyear_incomeperc}</td>
    <td style="vertical-align:top; padding:2px; border-bottom: dashed 1px #CCCCCC;" align="center"><input name="budgetline[{$rowid}][income]"  value="{$budgetline[income]}" data-rowid="{$rowid}" data-name="{$lang->income}" data-max="{$maxbudgetline[income]}" {$required} type="number" step="any" id="income_{$rowid}" size="10" />{$previous_yearsincome}</td>
