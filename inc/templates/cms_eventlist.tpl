        ...
        <td class="contentContainer">
            ...
            <form action='index.php?module=cms/eventlist' method="post">
                <table class="datatable" width="100%">
                    <thead>
                        <tr>
                            <th>{$lang->eventtitle} <a href="{$sort_url}&amp;sortby=title&amp;order=ASC"><img src="./images/sort_asc.gif" border="0" alt="{$lang->sortasc}"/></a><a href="{$sort_url}&amp;sortby=title&amp;order=DESC"><img src="./images/sort_desc.gif" border="0" alt="{$lang->sortdesc}"/></a></th>
                            <th>{$lang->location}</th>
