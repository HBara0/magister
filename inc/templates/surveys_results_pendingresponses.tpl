    ...
    <table class="datatable">
        <thead>
            <tr class="thead">
                ...
                <th>{$lang->employee} <a href="{$sort_url}&amp;sortby=employee&amp;order=ASC"><img src="./images/sort_asc.gif" border="0" alt="{$lang->sortasc}"/></a><a href="{$sort_url}&amp;sortby=employee&amp;order=DESC"><img src="./images/sort_desc.gif" border="0" alt="{$lang->sortdesc}"/></a></th>
            </tr>
        </thead>
