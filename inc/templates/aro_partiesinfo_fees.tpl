...
<tr class="altrow2"><td colspan="2">{$lang->totalfees}</td><td><input type="number" step="any" name="partiesinfo[totalfees]" id="partiesinfo_totalfees" value="$partiesinfo[totalfees]"></td>
</tr>