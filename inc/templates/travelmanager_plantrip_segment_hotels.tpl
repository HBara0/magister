<div style="display:block;width:100%;  border:1px solid #FCEFA1;  padding:5px;">
    ...
    <div style="display:inline-block;width:15%;"><input size="10" id="numnight_segacc_{$approved_hotels[tmhid]}_{$sequence}" accept="numeric" name="segment[{$sequence}][tmhid][{$checksum}][numNights]" type="text" value="{$selectedhotel->numNights}" max="{$leavedays}"> </div>
