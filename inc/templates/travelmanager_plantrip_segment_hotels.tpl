<div style="display:block;width:100%;">
    ...
    <div id="anotheraff_accomodations_{$sequence}_{$approved_hotels[tmhid]}" style="{$selectedhotel[$segid][$approved_hotels[tmhid]][display]} padding: 8px;" class="border_bottom border_left border_right border_top">
