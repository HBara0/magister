...
<tr>
    ...
    <td>
        <input type="hidden" id="subtotal_{$category->becid}_actualPrevThreeYears" value="{$subtotal[actualPrevThreeYears]}">
        <div id="subtotal_{$category->becid}_actualPrevThreeYears">{$subtotal[actualPrevThreeYears]}</div>
    </td>
    <td>
