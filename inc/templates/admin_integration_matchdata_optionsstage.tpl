...
<td class="contentContainer">
	...
	<form action="#" method="post" id="do_integration/matchdata_Form" name="do_integration/matchdata_Form" action="index.php?module=integration/matchdata">
        ...
        <table width="100%" class="datatable">
        	<tr>
            	<td>{$lang->matchwith}</td><td><select name="foreignSystem" id="foreignSystem"><option value="1">Outsys</option><option value="2">Sage Accpac</option><option value="3">Openbravo</option><option value="4">SYSPRO</option><option value="5">Iran ERP</option></select></td>
            </tr>
            <tr>
