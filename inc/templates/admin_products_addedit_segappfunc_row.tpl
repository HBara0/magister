<tr class='{$rowclass}'>
    <td width="1%"><input type="radio" name="defaultFunction" {$defaultfunctionchecked[$cfpid]} value="{$segmentapp_data[segappfuncs][safid]}" onclick="$('#applicationfunctions_{$segmentapp_data[segappfuncs][safid]}').attr('checked', 'checked')"/></td>
