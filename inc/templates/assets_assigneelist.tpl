<tr class="{$rowclass}" id="asset_{$assigneduser[auid]}"> 
    ...
    <td>{$assigneduser[fromDate_output]}</td>
     ...
     <td> <a href="#{$assigneduser[auid]}" style="display:none;" id="deleteuser_{$assigneduser[auid]}_assets/listuser_loadpopupbyid" rel="delete_{$assigneduser[auid]}"><img src="http://10.0.0.98/ocos/images/invalid.gif" alt="{$lang->delete}" border="0"></a> </td>
