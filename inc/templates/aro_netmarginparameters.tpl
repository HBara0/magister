    ...
    <table>
        ...
        <tbody id="productline_{$plrowid}_tbody" style="width:100%;">
            ...
            <tr>
                ...
                <td class="border_right" ><input type="number" min="0" name="parmsfornetmargin[localBankInterestRate]" id="parmsfornetmargin_localBankInterestRate" value="" style="width:150px;"/></td>
                <td class="border_right" ><input type="number" min="0" name="parmsfornetmargin[intermedBankInterestRate]" id="parmsfornetmargin_intermedBankInterestRate" value="" style="width:150px;"/></td>
            ...
            <tr>
                ...
                <td> <input type="text" name="parmsfornetmargin[warehousingRate]" id="parmsfornetmargin_warehousingRate" value="" style="width:150px;" readonly/></td>
            ...
            <tr>
                ...
                <td class="border_right" ><input type="text" name="parmsfornetmargin" id="parmsfornetmargin" value="" style="width:150px;" readonly/></td>
                <td class="border_right" ><input type="text" name="parmsfornetmargin" id="parmsfornetmargin" value="" style="width:150px;" readonly/></td>
