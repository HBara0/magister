<table style="color:black;" class="datatable">
    <thead style="width:60%">
        <tr style="background-color:#d8feb2;font-weight: bold">
            ...
            <td style="width:10%;">{$lang->shipmentstatusdesc}</td>
    ...
    <tbody>
        <tr style="background-color:#d8feb2;">
            <td>{$order[em_ork_eta]}</td>
            <td>{$order[em_ork_ets]}</td>
            <td>{$order[em_ork_shiptstatus]}</td>
            <td>{$order[em_ork_shipstatusdesc]}</td>
            <td style="width:10%;"></td>
            <td style="width:10%;"></td>
        </tr>
    </tbody>
