            ...
            $(function() {
                ...
                $('input[id^=lookuptransps_]').live('click', function() {
                    ...
                    if(typeof ciid !== typeof undefined && ciid !== '') {
                        ...
                        sharedFunctions.requestAjax("post", "index.php?module=travelmanager/plantrip&action=populatecontent", "&sequence=" + sequence + "&destcity=" + ciid + "&origincity=" + origincity + "&departuretime=" + $('#altpickDate_from_' + sequence).val() + "&arrivaltime=" + $('#altpickDate_to_' + sequence).val() + '&oneway=' + oneway + '&roundtrip=' + roundtrip, 'content_detailsloader_' + sequence + '', 'content_details_' + sequence + '', true);
