<table>
    <tr>
        ...
        <td colspan="3"><input type="file" id="uploadfile" name="uploadfile"{$uploadfile_disabled}></td>
    </tr>
    <tr>
        <td>{$lang->title}</td>
        <td><input name="title" id="title" type="text" maxlength="220" value="{$file[title]}"/></td>
        <td>{$lang->category}</td>
