<tr>
    <td ><div style="width:150px">{$marketintel[aff]}</div></td>
    <td ><div style="width:150px">{$marketintel[customer]}</div></td>
    <td ><div style="width:150px">{$marketintel[country]}</div></td>
