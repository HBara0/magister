<tr id='{$chemicalp_rowid}'>
    <td><input type='text' value="{$supplier[chemicalsubstances][$key][name]}" id='chemicalproducts_{$chemicalp_rowid}_QSearch' autocomplete='off' size='40px' placeholder="select chemical products"/>
