...
<div style="width:100%; text-align: left;">
        ...
        <div style="font-style:italic; text-decoration:underline; text-align:left; height:10mm; width: 100%;">{$lang->reportsenttofollowing}:</div>
        <div style="vertical-align:top; height:40mm; text-align: center; width: 100%;"><table width="100%">
        {$representatives_list}
        </table></div>
        <div style="padding-top: 10mm; width: 100%; text-align:left; vertical-align:top; height:10mm;">{$lang->contactchris}</div>
