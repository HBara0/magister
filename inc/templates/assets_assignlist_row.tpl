<tr class="{$rowclass}" id="assetuser_{$assigneduser[auid]}"> 
    ...
    <td id="assetuser_{$assigneduser[auid]}_tools">
        <div style="display:none;">
            {$tools}
            <a href="#{$assigneduser[auid]}" id="edituser_{$assigneduser[auid]}_assets/listuser_loadpopupbyid" rel="edit_{$assigneduser[auid]}"><img src='{$core->settings[rootdir]}/images/icons/edit.gif' border='0' title="{$lang->edit}"/></a>
        </div>
    </td>
</tr>                                                                           