<tr id="{$rowid}">
    <td>
        ...
        <input type='text' id='customer_{$rowid}_autocomplete' name="customeroder[$rowid][customerName]"  value="{$customeroder[customerName]}" autocomplete='off' required="required"/>
