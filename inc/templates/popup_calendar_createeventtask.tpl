...
<div id="popup_createeventtask" title="{$lang->createeventtask}">
    ...
    <form method="post" enctype="multipart/form-data" action="index.php?module=calendar/eventstasks" target="uploadFrame">      
        ...
        <input type="hidden" id="type" name="type" value= "event" />
            ...
            <div class="thead" style="cursor: pointer; margin-top:10px;"><a onClick="$('#attachments').fadeToggle();">{$lang->attachments}...</a></div>
            <div style="width:100%; height:50px; padding:5px; transition: background-color 0.5s ease; display:none; padding:5px; z-index:2;" id="attachments">
                <table>
                    <tr>
                        <td>
                    <tr>
                        <td>{$lang->selectfilename}</td>
                        <td>
                            <fieldset class="altrow2" style="border:1px solid #DDDDDD" title="Attachments">
