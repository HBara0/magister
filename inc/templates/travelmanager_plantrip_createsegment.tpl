    ...
    <table>
       ...
       <!-- <td> <span id="numdays_{$sequence}">{$segment[$sequence][numberdays]}</span></td>-->
        ...
        <tr>  <td>{$lang->origincity}</td>
            ...
            <td><input type="text"   id="destinationcity_{$sequence}_cache_autocomplete" autocomplete="off" tabindex="1" value="{$segment[$sequence][destinationcity][name]}" required="required" {$disabledfields[$sequence][destinationcity]}/>
