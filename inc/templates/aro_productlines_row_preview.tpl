<tr id="{$plrowid}"  class="{$plaltrow}">
    ...
    <td class="border_right">{$productline[totalBuyingValue]}</td>
    <td class="border_right">{$productline[costPrice]}</td>
    <td class="border_right">{$productline[costPriceAtRiskRatio]}</td>
