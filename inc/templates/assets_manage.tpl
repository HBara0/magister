        ...
        <form name="perform_assets/manageassets_Form" method="post" id="perform_assets/manageassets_Form"" >
            ...
            <div style="display:table; border-collapse:collapse; width:100%;">
                ...
                <div style="display:table-row;">
                    ...
                    <div style="display:table-cell; width:100%;padding:5px;"><input type="text" name="asset[status]" tabindex="3" value="{$assets[type]}"/></div>
                </div>
    ...
    <div style="display:table-row;">
                ...
                <div style="display:table-row;">
                    <div style="display: table-cell; width:20%;">
                        <input type="button" class="button" value="{$actiontype}" id="perform_assets/manageassets_Button" />
