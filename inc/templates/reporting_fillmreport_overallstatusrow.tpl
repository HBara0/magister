<tr id="{$rowid}">
    <td style="width: 40%; border-right: 1px solid #E8E8E8; border-bottom: 1px dashed #E8E8E8;" valign="top" class="altrow2">{$lang->productline}<br />
        {$generics_list}
        <input placeholder="{$lang->chemicalsubstance}" type='text' value="{$report_data[overallstatus][$rowid][chemsubstance]}" id='chemicalproducts_{$rowid}_autocomplete' autocomplete='off' size='40px'/>
