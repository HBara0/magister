...
<tr class="{$rowclass}">
    <td style="width:28%">{$lang->accountedcommissions}/{$type->title}</td>
    ...
    <td style="width:9%" class="border_left">{$combudget['prevyear'][$type->stid]['perc']}%</td>
    ...
    <td style="width:9%" class="border_left"><div id="placcount_{$category->name}_yefbud_{$type->stid}_perc">{$combudget[yefbud][$type->stid]['perc']}</div></td>
