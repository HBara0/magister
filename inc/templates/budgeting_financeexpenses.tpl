...
<tr>
    ...
    <td><div id="propfin_actualPrevThreeYears">{$propfin[actualPrevThreeYears]}</div></td>
    <td><div id="propfin_actualPrevTwoYears">{$propfin[actualPrevTwoYears]}</div></td>
   <!-- <td><div id="propfin_actualPrevTwoYears">{$propfin[actualPrevYear]}</div></td>
...
<tr>
    ...
    <td><div id="comexpenses_actualPrevThreeYears">{$comexpenses[actualPrevThreeYears]}</div></td>
    <td><div id="comexpenses_actualPrevTwoYears">{$comexpenses[actualPrevTwoYears]}</div></td>
   <!--  <td><div id="comexpenses_actualPrevTwoYears">{$comexpenses[actualPrevYear]}</div></td>
...
<tr>
    ...
    <td><div id="propcomexpenses_actualPrevThreeYears">{$propcomexpenses[actualPrevThreeYears]}</div></td>
    <td><div id="propcomexpenses_actualPrevTwoYears">{$propcomexpenses[actualPrevTwoYears]}</div></td>
  <!--   <td><div id="propcomexpenses_actualPrevTwoYears">{$propcomexpenses[actualPrevYear]}</div></td>
