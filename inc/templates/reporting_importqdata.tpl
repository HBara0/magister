...
{$menu}
    ...
    {$affid_field}
    <div>
        <select name="foreignSystem" id="foreignSystem"><option value="1">Outsys</option><option value="2">Sage Accpac</option><option value="3">Openbravo</option><option value="4">SYSPRO</option><option value="5">Iran ERP</option></select>
    </div>
