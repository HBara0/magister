<html>
<head>
<title>{$core->settings[systemtitle]} | {$lang->affiliateorder}</title>
{$headerinc}<script type="text/javascript">
$(function() {  
	...
	function getMoreData() {
		...
		{
			var url = "index.php?module=grouppurchase/affiliateorder&action=get_" + get;
