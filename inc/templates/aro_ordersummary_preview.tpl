    ...
    <table>
        ...
        <tbody style="width:100%;"  class="datatable">
            ...
            <tr style="font-weight: bold;background-color: #D0F6AA">
                <td class="altrow">{$lang->invoicevalue} (<span id="ordersummary_curr_0"></span>{$arorequest[currency]}) <a class="hidden-print" href="#" title="{$lang->invoicevaluedef}"><img src="./images/icons/question.gif"/></a></td>
            ...
            <tr style="background-color: #D0F6AA">
                <td class="altrow">{$lang->interestvalue} (<span id="ordersummary_curr_1"></span>{$arorequest[currency]}) <a class="hidden-print" href="#" title="{$lang->interestvaluedef}"><img src="./images/icons/question.gif"/></a></td>
            ...
            <tr {$ordersummarydisplay[thirdcolumn_display]}>
                <td class="altrow">{$lang->total} {$lang->netmargin} <br/>{$lang->afterdeduction}<a class="hidden-print" href="#" title="{$lang->totalnetmarginafterdeduction}"><img src="./images/icons/question.gif"/></a></td>
