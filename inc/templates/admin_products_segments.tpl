<html>
    ...
    <tr>
        ...
        <td class="contentContainer">
            ...
            <div style="right:11%;top:145px; position:fixed;" class="subtitle"> <a href="#" id="showpopup_addsegment" class="showpopup"><img  src="{$core->settings[rootdir]}/images/addnew.png" border="0">{$lang->addasegment}</a></div>
