<div id="expensescontainer" style="display:block;vertical-align: top; padding:5px;" class="border_bottom border_left border_right border_top">
    <div style="display:inline-block; vertical-align: top;"> {$lang->expectedamt} of {$rowid}</div>

    <div style="display:inline-block; text-align:left;   vertical-align: top;">
        <input tabindex="" accept="numeric"   value="{$expensestype[$sequence][$rowid][expectedAmt]}" id="expenses_expectedAmt"  size="20" name="segment[{$sequence}][expenses][{$rowid}][expectedAmt]" type="text"{$expenses_output_requiredattr}/>
    </div>
