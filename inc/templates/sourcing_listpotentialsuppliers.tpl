  ...
  <td class="contentContainer"><h3>{$lang->listpotentialsupplier}</h3>
    <form action='$_SERVER[REQUEST_URI]' method="post">
      <table class="datatable" width="100%">
       ...
       <div style="float:right;">{$lang->chemicalsearch}</div>
    <div style="-moz-box-sizing:border-box;-webkit-box-sizing: border-box;"> 
      <div style="width:50%; float:right; margin-top:0px; text-align:right;" class="smalltext">
        <input id="filters_chemical" name="filters[chemicalsubstance]" type="text" size="35">
      </div>
      </div>
    </form>
