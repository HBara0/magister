<div style="margin-bottom:5px;">
    ...
    <div style="padding:2px;">
        ...
        <div style="vertical-align: middle;"><div style="display: inline-block;"><img src='#' style="vertical-align: middle; "width="20" height="20"></div><div class="smalltext" style='color: #CCC; display: inline-block; line-height: 20px;'> · {$flight[carrier]} {$flight[flightnumber]} -- {$lang->class} {$flight[cabin]}</div></div>
    </div>
    {$connectionduration}
</div>
