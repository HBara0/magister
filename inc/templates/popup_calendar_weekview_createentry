		...
		<input type="hidden" id="uid" name="uid" value="{$core->user[uid]}" />
            <table>
                <tr>
                    ...
                    <td>
                        <input type="text" id="pickDate_from" name="pickDate_from" autocomplete="off" tabindex="1" value="" />
                        <input type="hidden" name="visit[fromDate]" id="altpickDate_from"  />
                        <input name="fromHour" type="text" id="fromHour" size="2"> <input name="fromMinutes" type="text" id="fromMinutes" size="2">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="pickDate_to" name="pickDate_to" autocomplete="off" tabindex="2" />
                        <input type="hidden" name="visit[toDate]" id="altpickDate_to" />
                        <input name="toHour" type="text" id="toHour" size="2">
                        <input name="toMinutes" type="text" id="toMinutes" size="2">
                        <span style="font-style:italic;" class="smalltext">(hh mm)</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type='text' id='customer_1_QSearch' value="" autocomplete="off" />
      	 ...
      	 <hr />
    	<input type='button' class='button' value='{$lang->create}' id='perform_calendar/weekviewoperations_Button' />
  	</form>
