<tr id='{$rowid}'>
    ...
    <td>
        <input type='text' id='pickDate_shiftfrom{$rowid}' autocomplete='off' value='{$fromDate[$rowid][output]}' />
        <input type='hidden' name='fromDate[{$rowid}]' id='altpickDate_shiftfrom{$rowid}' value='{$fromDate[$rowid][formatted]}'/>
    </td>
    <td>
        <input type='text' id='pickDate_shiftto{$rowid}' autocomplete='off' value='{$toDate[$rowid][output]}' />
