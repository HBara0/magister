            ...
            <td style="vertical-align:top;">
                <table>
                    ...
                    <tr class="altrow2"><td>{$lang->partiesinvolved}</td>
                        ...
                        <td>{$lang->isaff}<input type="checkbox" name="partiesinfo[vendorIsAff]" id="vendor_isaffiliate" value="1" {$checked}>
                    ...
                    <tr class="altrow2"><td>{$lang->totaldiscount} <a href="#" title="{$lang->totaldiscountdesc}"><img src="./images/icons/question.gif" ></a></td>
