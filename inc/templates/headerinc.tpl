...
<script src = "{$core->settings[rootdir]}/js/Jquery-tokeninput/src/jquery.tokeninput.js" type = "text/javascript" ></script>
<link href="{$core->settings[rootdir]}/js/Jquery-tokeninput/styles/token-input.css" rel="stylesheet" type="text/css" />
<link href="{$core->settings[rootdir]}/js/Jquery-tokeninput/styles/token-input-facebook.css" rel="stylesheet" type="text/css" />
