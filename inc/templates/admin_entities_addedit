...
<h3>{$pagetitle}</h3>
    ...
    {$eidfield}
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tr>
            <td width="20%"><strong>{$lang->entitytype}</strong></td><td>{$types_list}</td>
        </tr>
        <tr>
            <td width="20%" valign="top"><strong>{$lang->parentcompany}</strong></td><td><input type='text' id='supplier_1_QSearch' value="{$entity[parentName]}"/><input type="text" size="3" id="supplier_1_id_output" value="{$entity[parent]}" disabled/><input type='hidden' id='supplier_1_id' name='parent' value="{$entity[parent]}" /><div id='searchQuickResults_supplier_1' class='searchQuickResults' style='display:none;'></div></td>
        </tr>
        <tr>
