<tr id="{$rowid}">
  ...
  <td style="border-bottom: dashed 1px #CCCCCC;" align="center" class="altrow2 border_right"><input name="productactivity[$rowid][soldQty]" type="text" id="soldQty_{$rowid}" size="10" required="required" accept="numeric" value="{$productactivity[soldQty]}" autocomplete='off'/></td>
