<tr id="{$rowid}">
    ...
    <td style="border-bottom: dashed 1px #CCCCCC;" align="center" class="yellowbackground border_right"><input name="productactivity[$rowid][soldQty]" type="text" id="soldQty_{$rowid}" size="10" accept="numeric" value="{$productactivity[soldQty]}" autocomplete='off'/></td>
    <td  style="border-bottom: dashed 1px #CCCCCC;" align="center" class="altrow2 border_left"><input name="productactivity[$rowid][turnOver]" type="text" id="turnOver_{$rowid}" size="10" accept="numeric" value="{$productactivity[turnOver]}" autocomplete='off'/></td>
    <td style="border-bottom: dashed 1px #CCCCCC;" align="center" class='altrow2'>{$currencyfx_selectlist}</td>
    <td style="border-bottom: dashed 1px #CCCCCC;" align="center" class='altrow2'><input name="productactivity[$rowid][quantity]" type="text" id="quantity_{$rowid}" size="10" accept="numeric"  value="{$productactivity[quantity]}" autocomplete='off'/></td>
