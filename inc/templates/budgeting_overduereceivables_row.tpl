<tr class="{$rowclass}" id="{$rowid}">
    <td style="width:20%"> <input type='text' id='customer_{$rowid}_autocomplete' name="clientoverdue[$rowid][customerName]" value="{$clientoverdue->customername}" autocomplete='off' {$required} style="width:100%;"/>
        <input type='hidden' value="{$clientoverdue->cid}" id='customer_{$rowid}_id' name='clientoverdue[$rowid][cid]' />
