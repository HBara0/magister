...
<div style="display:inline-block; width:70%;">
    ...
    <div style="display:block">
        ...
        <div style="display:block;"><textarea name="lang[{$lid}][description]" cols="100" rows="6" id='functransdescription_{$lid}' class="basictxteditadv">{$trans[$lid]['description']}</textarea></div>
    </div>
</div>