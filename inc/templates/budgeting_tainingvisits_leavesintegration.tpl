<form name="trainingvisitsleaves" id="trainingvisitsleaves"  action="index.php?module=budgeting/trainingvisits&source=import" method="post">
    <div class="ui-state-highlight ui-corner-all datatable" style="padding-left: 5px; height:260px;  margin-bottom:10px; overflow: auto;">
        <input type="hidden" name="financialbudget[affid]" value="{$core->input[financialbudget][affid]}"/>
        <input type="hidden" name="financialbudget[year]" value="{$core->input[financialbudget][year]}"/>
        ...
        <table class="datatable" border="0" cellpadding="1" cellspacing="2" width="100%">
            <thead>
            <th width="1%"><input type="checkbox"  title="checkall" id='leave_checkall'/></th>
