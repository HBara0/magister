    ...
    <body>
        <script>
            ...
            $.post("index.php?module=crm/salesdashboard&action=do_perform_livesales", function(data) {
                ...
                chart2.addSeries(xaxislabel, yaxislabel, sales);
                chart2.setYAxis("", {numberHumanize: true});
                // db.addComponent(chart);
                chart2.unlock();

                db.setInterval(function() {
                    $.post("index.php?module=crm/livesalesperorganisation&action=do_perform_livesales", function(data) {
                        chart2.updateSeries(xaxislabel, data['sales']);
                    });
                }, 1500);
