    ...
    <tbody id="expenses{$rowid}_tbody">
        <tr id="{$rowid}"><td>
                ...
                <div style="display:block;padding:5px">
                    ...
                    <div style="display:inline-block;"  class=" subtitle">{$lang->other} <input type="checkbox" id="show_otherexpenses_{$sequence}_{$rowid}" value="1" name="segment[{$sequence}][{$rowid}][other]"/></div>
