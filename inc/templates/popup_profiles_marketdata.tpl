<div id="popup_profilesmarketdata" title="{$lang->addmarketdata}">
    <form name="perform_{$module}/{$modulefile}_Form" id="perform_{$module}/{$modulefile}_Form">
        ...
        <div>
            ...
            <div style="width: 60%; display: inline-block;"><input onFocus="$('#entbrandsproducts_0_cid').val($('#customer_2_id').val())" type="text" size="25" id="entbrandsproducts_0_autocomplete" size="100" autocomplete="off" value="{$midata->brandname}"/> | <a id="showpopup_createbrand" class="showpopup"><img src="{$core->settings[rootdir]}/images/addnew.png" border="0" title="{$lang->createbrand}"></a>
