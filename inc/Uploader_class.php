...
/*	public function ftp_custom_file($local, $remote) {
	...
	public function resize($new_width = 200, $newfile = '') {
		foreach($this->file[$this->fieldname]['type'] as $key => $val) {
			...
			switch($val) {
				case 'image/gif': $imagecreatefunc = 'imagecreatefromgif'; $imagefunc = 'imagegif'; $quality = 85; break;
				case 'image/jpeg': $imagecreatefunc = 'imagecreatefromjpeg'; $imagefunc = 'imagejpeg'; $quality = 85; break;
				case 'image/png': $imagecreatefunc = 'imagecreatefrompng'; $imagefunc = 'imagepng'; $quality = 8; break;
				case 'image/bitmap':  $imagecreatefunc = 'imagecreatefromwbmp'; $imagefunc = 'imagewbmp'; $quality = ''; break;
				default: unset($this->file_path[$key]); $this->set_status(0, $key); break;
			}
	...
	public function parse_status($error_code = 0) {
		switch($error_code) {
			case 0: $upload_result = "<span class='red_text'>Error while uploading</span>"; break;
			case 1: $upload_result = "<span class='red_text'>The file is too big</span>"; break;
			case 2: $upload_result = "<span class='red_text'>The file type is not allowed</span>"; break;
			case 3: $upload_result = "<span class='red_text'>A file with the same name already exists</span>"; break;
			case 4: $upload_result = "<span class='green_text'>Upload successful</span>"; break;	
		}
