...
CREATE TABLE `affiliatedentities` (
  ...
  KEY `affid` (`affid`,`eid`)
) ENGINE=MyISAM AUTO_INCREMENT=16979 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `assignedemployees` (
  ...
  KEY `eid` (`eid`,`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=62927 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cities` (
  ...
  `unlocode` varchar(4) CHARACTER SET utf8 NOT NULL,
  `oudeloc` varchar(5) CHARACTER SET utf8 DEFAULT NULL,
  `name` varchar(220) CHARACTER SET utf8 NOT NULL,
  `geoLocationText` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `geoLocation` point DEFAULT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=86725 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `entities` (
  ...
  PRIMARY KEY (`eid`)
) ENGINE=MyISAM AUTO_INCREMENT=4014 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `entitiessegments` (
  ...
  KEY `eid` (`eid`,`psid`)
) ENGINE=MyISAM AUTO_INCREMENT=7038 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `leaves` (
  ...
  KEY `coid` (`coid`),
  KEY `kiid` (`kiid`)
) ENGINE=MyISAM AUTO_INCREMENT=11080 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=2043 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
