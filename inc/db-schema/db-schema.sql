...
CREATE TABLE `affiliatedentities` (
  ...
  KEY `affid` (`affid`,`eid`)
) ENGINE=MyISAM AUTO_INCREMENT=17001 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `aro_policies` (
  ...
  `riskRatioIncreaseDiffCurrCN` tinyint(5) NOT NULL,
  `riskRatioDays` varchar(4) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `aro_requests` (
  ...
  `avgLocalInvoiceDueDate` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`aorid`),
...
CREATE TABLE `aro_requests_curstksupervision` (
  ...
  `inputChecksum` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `packing` varchar(44) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`arcssid`)
...
CREATE TABLE `aro_requests_linessupervision` (
  `arlsid` int(11) NOT NULL AUTO_INCREMENT,
  `aorid` int(10) NOT NULL,
  `quantity` float NOT NULL,
  `pid` int(10) NOT NULL,
  `packing` int(10) NOT NULL,
...
CREATE TABLE `assignedemployees` (
  ...
  KEY `eid` (`eid`,`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=62978 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `attendance_attrecords` (
  ...
  PRIMARY KEY (`aarid`)
) ENGINE=MyISAM AUTO_INCREMENT=77343 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `budgeting_budgets_lines` (
  ...
  `inputChecksum` varchar(200) DEFAULT NULL,
...
CREATE TABLE `budgeting_financialbudget` (
  ...
  `finGenAdmExpAmtApthy` float NOT NULL,
  `finGenAdmExpAmtApty` float NOT NULL,
  `finGenAdmExpAmtApy` float NOT NULL,
...
CREATE TABLE `budgeting_headcount` (
  ...
  `actualPrevThreeYears` int(11) NOT NULL,
  `actualPrevTwoYears` int(11) NOT NULL,
  `actualPrevYear` int(11) NOT NULL,
  `budgetPrevYear` int(11) NOT NULL,
  `yefPrevYear` int(11) NOT NULL,
  `budgetCurrent` int(11) NOT NULL,
  `createdBy` int(10) NOT NULL,
  `createdOn` bigint(30) NOT NULL,
  `modifiedBy` int(10) NOT NULL,
  `modifiedOn` bigint(30) NOT NULL,
...
CREATE TABLE `budgeting_overduereceivables` (
  ...
  `bfbid` int(10) NOT NULL,
  `cid` int(10) NOT NULL,
  `legalAction` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `budgeting_trainingvisits` (
  ...
  `modifiedBy` int(10) NOT NULL,
  `modifiedOn` bigint(30) NOT NULL,
  `inputChecksum` char(200) COLLATE utf8_unicode_ci NOT NULL,
  `lid` int(10) NOT NULL,
  PRIMARY KEY (`btvid`)
...
CREATE TABLE `chemfunctionchemcials` (
  ...
  UNIQUE KEY `safid` (`safid`,`csid`)
) ENGINE=MyISAM AUTO_INCREMENT=6264 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=1688 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=2208 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `chemicalsubstances` (
  ...
  PRIMARY KEY (`csid`)
) ENGINE=MyISAM AUTO_INCREMENT=6065 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cms_menuitems` (
  ...
  `itemclasses` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `cms_menus` (
  ...
  `title` varchar(220) COLLATE utf8_unicode_ci NOT NULL,
  `alias` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `submenuclasses` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `description` text COLLATE utf8_unicode_ci NOT NULL,
  `dateCreated` bigint(30) NOT NULL,
  `createdBy` int(10) NOT NULL,
  PRIMARY KEY (`cmsmid`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `cms_newshighlights`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `contactform_messages` (
  ...
  `purpose` varchar(180) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `countries` (
  ...
  `affid` smallint(5) unsigned NOT NULL,
  `name` varchar(220) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `altName` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `acronym` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `capitalCity` int(10) DEFAULT NULL,
  `mainCurrency` int(3) DEFAULT NULL,
  `defaultTimeZone` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=86748 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=1136 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=7046 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `entities` (
  ...
  `modifiedBy` int(10) NOT NULL,
  PRIMARY KEY (`eid`)
) ENGINE=MyISAM AUTO_INCREMENT=4015 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `entitiesbrandsproducts` (
  ...
  `pcvid` int(5) NOT NULL,
  `createdBy` int(10) NOT NULL,
  `createdOn` bigint(30) NOT NULL,
  `modifiedBy` int(10) NOT NULL,
  `modifiedOn` bigint(30) NOT NULL,
  `reviewedOn` int(50) NOT NULL,
...
CREATE TABLE `help_videos` (
  ...
  `embedLink` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `createdBy` int(10) NOT NULL,
  `createdOn` bigint(30) NOT NULL,
  `modifiedBy` int(10) NOT NULL,
  `modifiedOn` bigint(30) NOT NULL,
...
CREATE TABLE `integration_mediation_products` (
  ...
  KEY `affid` (`affid`)
) ENGINE=MyISAM AUTO_INCREMENT=14043 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `logs` (
  ...
  PRIMARY KEY (`lid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=89286 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `marketintelligence_basicdata` (
  ...
  `vridentifier` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `marketintelligence_competitors` (
  ...
  `modifiedBy` int(10) NOT NULL,
  `modifiedOn` bigint(30) NOT NULL,
  `incoterms` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `packaging` tinyint(4) NOT NULL,
  `saletype` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `isSampleacquire` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`micid`),
...
CREATE TABLE `marketreport_competition_products` (
  ...
  `howCanWeBeatThem` varchar(350) NOT NULL,
...
CREATE TABLE `purchasetypes` (
  ...
  `needsIntermediary` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`ptid`)
...
) ENGINE=MyISAM AUTO_INCREMENT=2057 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `segmentscategories` (
  ...
  `includeInWebsiteCarousel` tinyint(1) NOT NULL,
  PRIMARY KEY (`scid`)
...
CREATE TABLE `sourcing_suppliers` (
  ...
  PRIMARY KEY (`ssid`)
) ENGINE=MyISAM AUTO_INCREMENT=1339 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=110891 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=14429 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sourcing_suppliers_contacthist` (
  ...
  `isOrderPassed` tinyint(1) NOT NULL,
  PRIMARY KEY (`sschid`),
...
) ENGINE=MyISAM AUTO_INCREMENT=3511 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=8168 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `suppliersaudits` (
  ...
  PRIMARY KEY (`said`),
  KEY `eid` (`eid`,`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=3456 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `travelmanager_hotels` (
  ...
  `contactPerson` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `travelmanager_plan_finance` (
  ...
  `inputChecksum` varchar(150) NOT NULL,
  PRIMARY KEY (`tmpfid`),
  UNIQUE KEY `tmpfid` (`tmpfid`),
  UNIQUE KEY `tmpfid_2` (`tmpfid`),
  UNIQUE KEY `tmpfid_3` (`tmpfid`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `usergroups` (
  ...
  `budgeting_canFillFinBudgets` int(1) NOT NULL,
  `budgeting_canFillComAdmExp` int(1) NOT NULL,
...
CREATE TABLE `userspositions` (
  ...
  KEY `uid` (`uid`,`posid`)
) ENGINE=MyISAM AUTO_INCREMENT=2545 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
