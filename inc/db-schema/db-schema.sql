...
CREATE TABLE `affiliatedemployees` (
  ...
  KEY `affid` (`affid`,`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=4206 DEFAULT CHARSET=utf8;
...
CREATE TABLE `affiliatedentities` (
  ...
  KEY `affid` (`affid`,`eid`)
) ENGINE=MyISAM AUTO_INCREMENT=16981 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `assignedemployees` (
  ...
  KEY `eid` (`eid`,`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=62931 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `attendance_attrecords` (
  ...
  `operation` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`aarid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `chemicalsubstances` (
  ...
  PRIMARY KEY (`csid`)
) ENGINE=MyISAM AUTO_INCREMENT=6074 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cms_pages` (
  ...
  `metaDesc` text COLLATE utf8_bin NOT NULL,
  `metaKeywords` text COLLATE utf8_bin NOT NULL,
  `robotsRule` varchar(100) COLLATE utf8_bin NOT NULL,
  `createdBy` int(10) NOT NULL,
  `dateCreated` bigint(30) NOT NULL,
  `modifiedBy` int(10) NOT NULL,
  `dateModified` bigint(30) NOT NULL,
  `hits` mediumint(8) unsigned NOT NULL,
  `uploadedImages` varchar(1000) COLLATE utf8_bin NOT NULL DEFAULT '',
...
) ENGINE=MyISAM AUTO_INCREMENT=7067 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `entitiessegments` (
  ...
  KEY `eid` (`eid`,`psid`)
) ENGINE=MyISAM AUTO_INCREMENT=7040 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `leaves` (
  ...
  KEY `coid` (`coid`),
  KEY `kiid` (`kiid`)
) ENGINE=MyISAM AUTO_INCREMENT=11147 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `logs` (
  ...
  PRIMARY KEY (`lid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=27400 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `purchasetypes` (
  ...
  `needsIntermediary` tinyint(10) NOT NULL DEFAULT '1',
  PRIMARY KEY (`ptid`)
...
CREATE TABLE `representatives` (
  ...
  PRIMARY KEY (`rpid`)
) ENGINE=MyISAM AUTO_INCREMENT=5893 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=2048 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `usergroups` (
  ...
  `MIRepcrm_canGenerateMIRep` tinyint(1) NOT NULL,
