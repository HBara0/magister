...
CREATE TABLE `affiliatedemployees` (
  ...
  KEY `affid` (`affid`,`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=4185 DEFAULT CHARSET=utf8;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `affiliatemanagementlog`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `affiliates` (
  ...
  `cpAccount` varchar(10) DEFAULT NULL,
  ...
  `hrManager` int(10) unsigned NOT NULL,
  `finManager` int(10) unsigned DEFAULT NULL,
  `logisticsManager` int(10) NOT NULL DEFAULT '0',
  `commercialManager` int(10) NOT NULL,
  `regionalSupervisor` int(10) NOT NULL DEFAULT '0',
  `globalPurchaseManager` int(10) NOT NULL DEFAULT '0',
  `coo` int(10) NOT NULL DEFAULT '0',
...
CREATE TABLE `aro_ordersummary` (
  ...
  `globalNetmarginPerc` float NOT NULL,
...
CREATE TABLE `aro_requests_lines` (
  ...
  `fees` float NOT NULL,
  `riskRatioAmount` float NOT NULL,
  PRIMARY KEY (`arlid`)
...
CREATE TABLE `aro_requests_partiesinformation` (
  ...
  `shipmentPort` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `assignedemployees` (
  ...
  KEY `eid` (`eid`,`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=65041 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `attendance_attrecords` (
  ...
  `lastupdateTime` bigint(30) DEFAULT NULL,
  `lastupdateOperation` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `budgeting_budgets_lines` (
  ...
  KEY `createdBy` (`createdBy`),
  KEY `businessMgr` (`businessMgr`)
) ENGINE=MyISAM AUTO_INCREMENT=18088 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `budgeting_yef_lines` (
  ...
  `octoberqty` float NOT NULL,
  `novemberqty` float NOT NULL,
  `decemberqty` float NOT NULL,
  `quantity` float NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=34259 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=34507 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cms_highlights` (
  ...
  `inlineHtml` text COLLATE utf8_unicode_ci NOT NULL,
  `imgPath` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `targetLink` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `graphTitle` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `cms_news` (
  ...
  `baseVersionId` int(10) DEFAULT NULL,
  PRIMARY KEY (`cmsnid`),
...
) ENGINE=MyISAM AUTO_INCREMENT=118139 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=7182 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `endproducttypes` (
  ...
  KEY `psaid` (`psaid`)
) ENGINE=MyISAM AUTO_INCREMENT=1394 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `entities` (
  ...
  `inputChecksum` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `mainSupplyLine` varchar(200) DEFAULT NULL,
  `supplierSince` bigint(30) DEFAULT NULL,
  ...
  `customerSince` bigint(30) DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `entities3`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `entities3` (
  ...
  `approved` smallint(1) unsigned NOT NULL DEFAULT '0',
  `isActive` tinyint(1) NOT NULL DEFAULT '1',
  `dateAdded` bigint(30) unsigned DEFAULT NULL,
  `notes` text,
  `type` char(2) NOT NULL,
  `supplierType` tinyint(1) DEFAULT NULL,
  `productsType` varchar(15) DEFAULT NULL,
...
CREATE TABLE `entitiesbrands` (
  ...
  `modifiedOn` bigint(30) NOT NULL,
  PRIMARY KEY (`ebid`),
  UNIQUE KEY `name` (`name`,`eid`,`isGeneral`),
...
CREATE TABLE `entitiesbrandsproducts` (
  ...
  `pcvid` int(5) DEFAULT '0',
  `description` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `createdBy` int(10) NOT NULL,
  `createdOn` bigint(30) NOT NULL,
  `modifiedBy` int(10) NOT NULL,
  `modifiedOn` bigint(30) NOT NULL,
  `reviewedOn` bigint(30) DEFAULT NULL,
  `reviewedBy` int(10) DEFAULT NULL,
  `classificationClass` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`ebpid`,`ebid`,`eptid`),
  UNIQUE KEY `ebid` (`ebid`,`eptid`,`pcvid`),
  KEY `createdBy` (`createdBy`,`modifiedBy`)
...
CREATE TABLE `facilitymgmt_facilities` (
  ...
  `numOccupants` smallint(5) NOT NULL,
...
CREATE TABLE `genericproducts` (
  ...
  `title` varchar(220) NOT NULL,
  `description` text,
  `isSegmentDefault` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`gpid`),
  KEY `psid` (`psid`)
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `helptouritems`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `helptouritems` (
  `htiid` int(11) NOT NULL AUTO_INCREMENT,
  `sequence` smallint(5) NOT NULL,
  `reference` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `text` text COLLATE utf8_unicode_ci NOT NULL,
  `options` text COLLATE utf8_unicode_ci,
  `ignoreId` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`htiid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `hr_jobapplicants` (
  `jaid` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `integration_mediation_entities` (
  ...
  `contactPersonName` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `country` int(10) NOT NULL,
  `city` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `addressLine1` varchar(220) COLLATE utf8_unicode_ci DEFAULT NULL,
  `addressLine2` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `mainEmail` varchar(220) CHARACTER SET latin1 DEFAULT NULL,
  `paymentTerms` int(3) DEFAULT NULL,
  `foreignDate` bigint(30) DEFAULT NULL,
...
CREATE TABLE `integration_mediation_products2` (
  `impid` int(20) NOT NULL AUTO_INCREMENT,
  `localId` int(10) NOT NULL DEFAULT '0',
  `foreignSystem` tinyint(1) NOT NULL DEFAULT '1',
  `foreignId` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `foreignName` varchar(220) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `foreignNameAbbr` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `foreignSupplier` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `affid` int(10) NOT NULL,
  `localDate` bigint(30) DEFAULT NULL,
  `foreignDate` bigint(30) DEFAULT NULL,
  `type` tinyint(1) DEFAULT NULL,
  `addedBy` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`impid`,`localId`,`foreignSystem`,`foreignId`),
  UNIQUE KEY `foreignId` (`foreignId`,`foreignNameAbbr`,`affid`),
  KEY `affid` (`affid`)
) ENGINE=MyISAM AUTO_INCREMENT=112 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `integration_mediation_purchaseinvoicelines`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `integration_mediation_purchaseinvoicelines` (
  `impilid` int(10) NOT NULL AUTO_INCREMENT,
  `foreignId` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `producerPrice` float DEFAULT NULL,
  `quantity` float NOT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `integration_mediation_purchaseinvoices`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `integration_mediation_purchaseinvoices` (
  `impiid` int(10) NOT NULL AUTO_INCREMENT,
  `foreignSystem` tinyint(1) NOT NULL,
  `foreignId` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  `docNum` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `date` bigint(30) NOT NULL,
  `spid` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  `affid` int(10) NOT NULL,
  `currency` varchar(4) COLLATE utf8_unicode_ci NOT NULL,
  `usdFxrate` float DEFAULT NULL,
  `paymentTerms` int(3) DEFAULT NULL,
  `purchaseType` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `foreignOrderId` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`impiid`),
  KEY `cid` (`spid`,`affid`),
  KEY `foreignId` (`foreignId`)
...
CREATE TABLE `integration_mediation_purchaseorders` (
  ...
  `foreignInvoiceId` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`impoid`),
  KEY `cid` (`spid`,`affid`)
) ENGINE=MyISAM AUTO_INCREMENT=6234 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `integration_mediation_salesinvoicelines`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `integration_mediation_salesinvoicelines` (
  `imsilid` int(10) NOT NULL AUTO_INCREMENT,
  `foreignId` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  `foreignOrderId` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  `pid` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  `spid` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `quantityUnit` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `cost` float NOT NULL,
  `costCurrency` varchar(4) COLLATE utf8_unicode_ci DEFAULT NULL,
  `purchasePrice` float NOT NULL,
  `purPriceCurrency` varchar(4) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`imsilid`),
  KEY `pid` (`pid`,`spid`),
  KEY `foreignOrderId` (`foreignOrderId`),
  KEY `foreignId` (`foreignId`)
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `integration_mediation_salesinvoices`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `integration_mediation_salesinvoices` (
  `imsiid` int(10) NOT NULL AUTO_INCREMENT,
  `foreignSystem` tinyint(1) NOT NULL,
  `foreignId` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  `docNum` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `date` bigint(30) NOT NULL,
  ...
  `usdFxrate` float DEFAULT NULL,
  `paymentTerms` int(3) DEFAULT NULL,
  `salesRep` varchar(220) COLLATE utf8_unicode_ci NOT NULL,
  `salesRepLocalId` int(10) NOT NULL,
  `saleType` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `foreignOrderId` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`imsiid`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `integration_mediation_salesorderlines_20150926`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `integration_mediation_salesorderlines_20150926` (
  `imsolid` int(10) NOT NULL AUTO_INCREMENT,
  `foreignId` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `foreignOrderId` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `pid` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `integration_mediation_salesorders_20150926`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `integration_mediation_salesorders_20150926` (
  `imsoid` int(10) NOT NULL AUTO_INCREMENT,
  `foreignSystem` tinyint(1) NOT NULL,
  `foreignId` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `docNum` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  KEY `cid` (`cid`,`affid`,`salesRep`),
  KEY `salesRepLocalId` (`salesRepLocalId`)
) ENGINE=MyISAM AUTO_INCREMENT=20950 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `leaves` (
  ...
  `numWorkingDays` float NOT NULL DEFAULT '0',
  `type` smallint(5) NOT NULL,
  `reason` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `contactPerson` int(10) unsigned NOT NULL DEFAULT '0',
  `addressWhileAbsent` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `phoneWhileAbsent` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `requestTime` bigint(30) NOT NULL,
  `limitedEmail` tinyint(1) NOT NULL DEFAULT '1',
  `affToInform` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  ...
  `psid` smallint(5) DEFAULT NULL,
  `ltpid` mediumint(10) DEFAULT NULL,
  `sourceCity` int(10) DEFAULT NULL,
  `destinationCity` int(10) DEFAULT NULL,
  `createAutoResp` tinyint(1) NOT NULL DEFAULT '0',
  `autoRespSubject` varchar(220) DEFAULT NULL,
  `autoRespBody` text,
  PRIMARY KEY (`lid`),
  KEY `uid` (`uid`),
  KEY `type` (`type`),
  ...
  KEY `kiid` (`kiid`),
  KEY `psid` (`psid`,`ltpid`)
) ENGINE=MyISAM AUTO_INCREMENT=14090 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `logs` (
  ...
  PRIMARY KEY (`lid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=78213 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `logs_userpages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `logs_userpages` (
  `lupid` int(10) NOT NULL AUTO_INCREMENT,
  `uid` int(10) NOT NULL,
...
CREATE TABLE `marketintelligence_basicdata` (
  ...
  `cid` int(10) NOT NULL,
  `cfpid` int(10) NOT NULL DEFAULT '0',
  `cfcid` int(10) NOT NULL DEFAULT '0',
  `biid` int(10) NOT NULL DEFAULT '0',
  `ebpid` int(10) NOT NULL,
  `eptid` int(10) NOT NULL,
  `affid` smallint(5) NOT NULL,
  `vrid` int(10) NOT NULL DEFAULT '0',
  `vridentifier` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `potential` float NOT NULL DEFAULT '0',
  `mktSharePerc` float NOT NULL DEFAULT '0',
  `mktShareQty` float NOT NULL DEFAULT '0',
  ...
  `modifiedOn` bigint(30) DEFAULT NULL,
  PRIMARY KEY (`mibdid`),
  UNIQUE KEY `cid_2` (`cid`,`cfpid`,`cfcid`,`biid`,`ebpid`,`eptid`,`affid`,`vrid`,`createdOn`),
...
CREATE TABLE `products` (
  ...
  `syncCompleted` tinyint(1) NOT NULL,
  PRIMARY KEY (`pid`),
  KEY `spid` (`spid`,`gpid`,`name`,`code`),
  KEY `defaultFunction` (`defaultFunction`),
  FULLTEXT KEY `name` (`name`,`description`)
) ENGINE=MyISAM AUTO_INCREMENT=2788 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reportssendlog` (
  ...
  `readyForSending` tinyint(1) NOT NULL,
  `distributedReportsSent` tinyint(1) NOT NULL,
  PRIMARY KEY (`rslid`),
...
CREATE TABLE `surveys` (
  ...
  `isQuiz` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `surveys_responses` (
  ...
  `responseValue` int(10) DEFAULT NULL,
  `comments` text,
...
CREATE TABLE `surveys_templates_questions` (
  ...
  `choicesSeperator` varchar(10) DEFAULT NULL,
...
DROP TABLE IF EXISTS `system_assignedwidgets`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `system_assignedwidgets` (
  `sawid` int(10) NOT NULL AUTO_INCREMENT,
  `sdid` int(10) NOT NULL,
  `swgiid` int(10) NOT NULL,
  `createdOn` bigint(30) NOT NULL,
  `createdBy` int(10) NOT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `system_conversationmethods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `system_conversationmethods` (
  `scmtid` int(10) NOT NULL AUTO_INCREMENT,
  `module` varchar(75) COLLATE utf8_unicode_ci NOT NULL,
  `class` varchar(75) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `system_conversations` (
  ...
  `inputChecksum` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`scid`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `system_dashboard` (
  ...
  `alias` varchar(75) COLLATE utf8_unicode_ci NOT NULL,
  `inputChecksum` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `uid` int(10) NOT NULL,
  `isActive` tinyint(1) NOT NULL DEFAULT '1',
  `columnCount` tinyint(1) NOT NULL,
  `moduleName` varchar(75) COLLATE utf8_unicode_ci NOT NULL,
  `pageName` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `createdBy` int(10) NOT NULL,
  `createdOn` bigint(30) NOT NULL,
  `modifiedBy` int(10) NOT NULL,
<<<<<<< Updated upstream
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `system_foreigntables` (
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `system_foreigntables_columns`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `system_foreigntables_columns` (
...
CREATE TABLE `system_languages_varvalues` (
  ...
  KEY `createdBy` (`createdBy`)
) ENGINE=MyISAM AUTO_INCREMENT=3202 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
=======
>>>>>>> Stashed changes
DROP TABLE IF EXISTS `system_widgetinstances`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `system_widgetinstances` (
  `swgiid` int(10) NOT NULL AUTO_INCREMENT,
  `title` varchar(75) COLLATE utf8_unicode_ci NOT NULL,
  `alias` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  `inputChecksum` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `uid` int(10) NOT NULL,
  `serializedConfig` text COLLATE utf8_unicode_ci NOT NULL,
  `type` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `isActive` tinyint(1) NOT NULL DEFAULT '1',
  `createdBy` int(10) NOT NULL,
  `createdOn` bigint(30) NOT NULL,
  `modifiedBy` int(10) NOT NULL,
  `modifiedOn` bigint(30) NOT NULL,
  `swdgid` int(10) NOT NULL,
  PRIMARY KEY (`swgiid`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `system_widgets`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `system_widgets` (
  `swdgid` int(10) NOT NULL AUTO_INCREMENT,
  `moduleId` int(10) NOT NULL,
  `moduleName` varchar(75) COLLATE utf8_unicode_ci NOT NULL,
  `title` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `isChart` tinyint(1) NOT NULL,
  `createdOn` bigint(30) NOT NULL,
  `createdBy` int(10) NOT NULL,
  `modifiedOn` bigint(30) NOT NULL,
  `modifiedBy` int(10) NOT NULL,
  `serializedConfig` text COLLATE utf8_unicode_ci NOT NULL,
  `className` varchar(75) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`swdgid`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `system_conversations`;
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `system_widgets` (
  `swgid` int(10) NOT NULL AUTO_INCREMENT,
  `title` varchar(75) COLLATE utf8_unicode_ci NOT NULL,
  `alias` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  `uid` int(10) NOT NULL,
  `jsonConfig` text COLLATE utf8_unicode_ci NOT NULL,
  `type` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `isActive` tinyint(1) NOT NULL,
  `createdBy` int(10) NOT NULL,
  `createdOn` bigint(30) NOT NULL,
...
CREATE TABLE `travelmanager_plan` (
  ...
  `modifiedOn` bigint(30) NOT NULL,
  `isFinalized` tinyint(1) NOT NULL DEFAULT '0',
  `expensesFilled` tinyint(1) NOT NULL,
  PRIMARY KEY (`tmpid`),
  KEY `lid` (`lid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `uom` (
  ...
  `isVolume` tinyint(4) NOT NULL DEFAULT '0',
  `isDerivedUnit` tinyint(4) NOT NULL DEFAULT '0',
  `isTime` tinyint(1) NOT NULL DEFAULT '0',
  `isArea` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`uomid`)
...
CREATE TABLE `usergroups` (
  ...
  `hr_canCreateJobOpport` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `budgeting_cangenerateFinBudgets` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `canUseFacM` tinyint(1) NOT NULL DEFAULT '0',
  `facilitymgmt_canManageFacilities` tinyint(1) NOT NULL DEFAULT '0',
  `isSalesRep` tinyint(1) NOT NULL,
  PRIMARY KEY (`gid`)
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `users_transferedassignments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `users_transferedassignments` (
  `utaid` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `userspositions` (
  ...
  KEY `uid` (`uid`,`posid`)
) ENGINE=MyISAM AUTO_INCREMENT=2557 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
