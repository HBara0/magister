 ...
 *   https://datatables.net/download/#dt/dt-1.10.10,cr-1.3.0,fc-3.2.0,fh-3.1.0,r-2.0.0,rr-1.1.0
 *
 * Included libraries:
 *   DataTables 1.10.10, ColReorder 1.3.0, FixedColumns 3.2.0, FixedHeader 3.1.0, Responsive 2.0.0, RowReorder 1.1.0
 */
...
(function($, window, document, undefined) {
    ...
    function _fnFeatureHtmlFilter(settings)
    {
        ...
        var input = '<div class="input-group"> <span class="input-group-addon glyphicon glyphicon-search" id="datatablesaddone-' + tableId + '"></span> <input type="search" class="form-control ' + classes.sFilterInput + '" placeholder="Search" aria-describedby="datatablesaddone-' + tableId + '" style="margin-left:0px"></div>';
    ...
    DataTable.defaults = {
        ...
        "oLanguage": {
             ...
             *    } );
             */
            "sLengthMenu": 'Show <select class="form-control">\
...
<option value="-1" >All</option>\
    ...
    DataTable.ext = _ext = {
         ...
         *  @type string
         */
        build: "dt/dt-1.10.10,cr-1.3.0,fc-3.2.0,fh-3.1.0,r-2.0.0,rr-1.1.0",
        /**
         * Error reporting.
         *
