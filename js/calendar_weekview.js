	...
	$(".calendar_hourevent").live('mouseover', function() {
		$(this).resizable({
			...
			stop: function(event, ui) {
				...
				$.post("index.php?module=calendar/weekviewoperations&action=update_time", { todiff: diff, id: id[1] }, function(returnedData) { if(returnedData == '0') { $('#leave_'+id[1]).animate({height: ui.originalSize.height}, 'fast'); }});	
			}
		});
	});
