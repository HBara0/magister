...
<tr><td colspan="3"><strong>{$lang->marktrendcompetition}</strong></td></tr>
    ...
    <tr><td colspan="3"><strong>{$lang->quarterlyhighlights}</strong></td></tr>
       <tr>
    	<td><textarea cols="55" rows="5" id="quarterlyHighlights{$segment[psid]}" name="marketreport[{$segment[psid]}][quarterlyHighlights]">{$marketreport[$segment[psid]][quarterlyHighlights]}</textarea></td>
     ...
     <tr>
    	<td><textarea cols="55" rows="5" id="devProjectsNewOp{$segment[psid]}" name="marketreport[{$segment[psid]}][devProjectsNewOp]">{$marketreport[$segment[psid]][devProjectsNewOp]}</textarea></td>
    ...
    <tr>
    	<td><textarea cols="55" rows="5" id="issues{$segment[psid]}" name="marketreport[{$segment[psid]}][issues]">{$marketreport[$segment[psid]][issues]}</textarea></td>
    ...
    <tr><td colspan="3"><strong>{$lang->actionplan}</strong></td></tr>
      <tr>
    	<td><textarea cols="55" rows="5" id="actionPlan{$segment[psid]}" name="marketreport[{$segment[psid]}][actionPlan]">{$marketreport[$segment[psid]][actionPlan]}</textarea></td>
