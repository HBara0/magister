...
if($_REQUEST['authkey'] == 'kia5ravb$op09dj4a!xhegalhj') {
    ...
    $unfinalizedreports = ReportingQReports::get_data(array('year' => $quarter['year'], 'modifiedOn' => $timelimit, 'type' => 'q', 'prActivityAvailable' => 1, 'mktReportAvailable' => 1, 'status' => 0, 'isSent' => 0, 'quarter' => $quarter['quarter']), array('operators' => array('modifiedOn' => 'lt'), 'returnarray' => true));
