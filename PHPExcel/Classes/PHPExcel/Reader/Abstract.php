...
abstract class PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader {
    ...
    protected function openPage($htmlpage) {
        if(!is_string($htmlpage) || empty($htmlpage)) {
            throw new PHPExcel_Reader_Exception("Could not open ".$htmlpage." for reading! Page does not exist.");
        }
        $this->fileHandle = $htmlpage;
    }
