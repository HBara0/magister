...
if(!($core->input['action'])) {
    if($core->input['referrer'] == 'generate') {
        ...
        /* split the dimension and explode them into chuck of array */
        //$mireportdata['dimension'] = $dimensionalize_ob->construct_dimensions($mireportdata['dimension']);
        ...
        unset($mireportdata['filter']['spid'], $mireportdata['filter']['psid']);

        $marketin_objs = MarketIntelligence::get_marketdata_dal($mireportdata['filter'], array('simple' => false, 'operators' => array('cfpid' => 'IN')));
