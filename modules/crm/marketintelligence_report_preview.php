...
if(!($core->input['action'])) {
    if($core->input['referrer'] == 'generate') {
        ...
        $mireportdata['dimension'] = array();
        $mireportdata['dimension'] = array(1 => 'affid', 2 => 'coid', 3 => 'cid', 4 => 'pid');


        $marketdata_indexes = array('potential', 'mktSharePerc');
        ...
        if(is_array($marketin_objs)) {
            ...
            $market_data = array();
            $market_data = array(70 => array('affid' => 1, 'cid' => 142, 'coid' => 1, 'pid' => 500, 'bdid' => 70, 'potential' => 1000, 'mktSharePerc' => 0.2),
                    71 => array('affid' => 1, 'cid' => 136, 'pid' => 500, 'coid' => 1, 'bdid' => 71, 'potential' => 2000, 'mktSharePerc' => 0.5),
                    72 => array('affid' => 2, 'cid' => 137, 'pid' => 500, 'coid' => 2, 'bdid' => 72, 'potential' => 3000, 'mktSharePerc' => 0.5),
                    73 => array('affid' => 1, 'cid' => 138, 'pid' => 500, 'coid' => 1, 'bdid' => 70, 'potential' => 1000, 'mktSharePerc' => 0.2),
                    74 => array('affid' => 1, 'cid' => 139, 'pid' => 500, 'coid' => 1, 'bdid' => 71, 'potential' => 2000, 'mktSharePerc' => 0.5),
                    75 => array('affid' => 2, 'cid' => 141, 'pid' => 500, 'coid' => 2, 'bdid' => 72, 'potential' => 3000, 'mktSharePerc' => 0.5)
            );
            
            if(is_array($market_data)) {
                $multidimension_data = dimentionalize_data($market_data, $mireportdata['dimension'], $marketdata_indexes);
            }

            $totals = array();
            print_r($mireportdata['dimension']);
            reset($mireportdata['dimension']);
