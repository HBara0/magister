	...
	elseif($core->input['action'] == 'thumbnail') 
	{
		...
		if(!file_exists('./uploads/sharedfiles/thumbnails/th_'.$file['name'])) {
			switch(strtolower($file['type'])) {
				case 'gif': $imagecreatefunc = 'imagecreatefromgif'; $imagefunc = 'imagegif'; $quality = 85; break;
				case 'jpg': $imagecreatefunc = 'imagecreatefromjpeg'; $imagefunc = 'imagejpeg'; $quality = 85; break;
				case 'png': $imagecreatefunc = 'imagecreatefrompng'; $imagefunc = 'imagepng'; $quality = 8; break;
				case 'bmp':  $imagecreatefunc = 'imagecreatefromwbmp'; $imagefunc = 'imagewbmp'; $quality = ''; break;
				default: break;
			}
